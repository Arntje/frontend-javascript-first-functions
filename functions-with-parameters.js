...
let seconds1 = minutesToSeconds(1);
let seconds3 = minutesToSeconds(3);
let seconds23 = minutesToSeconds(23);

console.log(seconds1);
console.log(seconds3)
console.log(seconds23);
...
function merge(wordOne, wordTwo)  {
  return   wordOne + wordTwo;
}
const magicWord = merge("abra", "cadabra");
const tasty = merge("zoet", "sappig");
...
const humanAge6 = calculateDogYears(6);
const humanAge2 = calculateDogYears(2);

console.log(humanAge6);
...
const starGlasses = wrapper("bril", "*");
const underscoredBeep = wrapper("beep", "_");
const quedCheese = wrapper("kaas", "Q");

console.log(starGlasses);
console.log(underscoredBeep);
console.log(quedCheese);
...
const me = createDetailString("Arnt", "Braakenburg", "inbetween jobs");
console.log(me);
